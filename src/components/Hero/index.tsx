            ...
            <div className="w-full px-4">
              ...
              >
                <h1 className="mb-6 text-3xl font-bold leading-snug text-white sm:text-4xl sm:leading-snug lg:text-5xl lg:leading-[1.2]">
                  Your one place solution for Invoice Discouting
                </h1>
                <p className="mx-auto mb-9 max-w-[600px] text-base font-light text-white sm:text-lg sm:leading-[1.44]">
                  ...
                  Leveraging Solana blockchain technology to empower businesses to access cash flow on their terms.
                </p>
                <ul className="mb-10 flex flex-wrap items-center justify-center gap-5">
                  <li>
                    <Link
                      href="https://nextjstemplates.com/templates/Invoicely"
                ...
                <div>
                  <p className="mb-4 text-center text-base font-medium text-white/60">
                    Invoicely currently only support Solana
                  </p>
                </div>
              </div>
            </div>
